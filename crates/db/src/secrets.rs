...
const FREE_ENV_KEY_MAP: &[(&str, &str)] = &[
    ...
    ("ADE_GITLAB_API_KEY", "gitlab"),
    ("STRIPE_SECRET_KEY", "stripe"),
    ("STRIPE_API_KEY", "stripe"),
    ("ADE_STRIPE_API_KEY", "stripe"),
    ("AZURE_CLIENT_SECRET", "azure"),
    ("AZURE_DEVOPS_EXT_PAT", "azure"),
    ("AZURE_PAT", "azure"),
    ("ADE_AZURE_API_KEY", "azure"),
    ("AWS_SECRET_ACCESS_KEY", "aws"),
    ("ADE_AWS_API_KEY", "aws"),
    ("SLACK_BOT_TOKEN", "slack"),
    ("SLACK_TOKEN", "slack"),
    ("ADE_SLACK_API_KEY", "slack"),
    ("LINEAR_API_KEY", "linear"),
    ("ADE_LINEAR_API_KEY", "linear"),
    ("JIRA_API_TOKEN", "jira"),
    ("ATLASSIAN_API_TOKEN", "jira"),
    ("ADE_JIRA_API_KEY", "jira"),
    ("NOTION_TOKEN", "notion"),
    ("NOTION_API_KEY", "notion"),
    ("ADE_NOTION_API_KEY", "notion"),
    ("DISCORD_BOT_TOKEN", "discord"),
    ("DISCORD_TOKEN", "discord"),
    ("ADE_DISCORD_API_KEY", "discord"),
];
